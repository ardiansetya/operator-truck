...
Route::middleware(['auth.token.refresh', 'role:ADMIN'])->group(function () {
    ...
    Route::get('/deliveries/tracking', [DeliveryController::class, 'tracking'])->name('deliveries.tracking');
    Route::get('/api/deliveries/tracking', [DeliveryController::class, 'getActiveDeliveriesWithPositions']);
