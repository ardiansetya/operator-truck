        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            @forelse ($routes as $route)
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <!-- Cargo Type -->
                        @if (isset($route['type_cargo']) || isset($route['type_cargo_name']))
                            <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-blue-800">Jenis Kargo</p>
                                        <p class="text-sm text-blue-600">
                                            {{ $route['type_cargo_name'] ?? 'Tipe #' . $route['type_cargo'] }}
                                        </p>
                                    </div>
                                </div>
                            </div>
