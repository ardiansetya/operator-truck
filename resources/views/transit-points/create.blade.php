...
@section('title', 'Tambah Transit Point')
    ...
    <div class="min-h-screen py-8">
        <div class="container mx-auto px-6 max-w-2xl">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Transit Point</h1>
                <p class="text-gray-600">Isi detail transit point untuk menambahkan ke dalam sistem</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border-0 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-8 py-6">
                    <h2 class="text-xl font-semibold text-white flex items-center">
                        ...
                        Informasi Transit Point
                    </h2>
                </div>

                <form method="POST" action="{{ route('transit-points.store') }}" class="p-8">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500">Belum ada kota Pemuatan? <a href="{{ route('cities.create') }}" class="text-blue-500">Tambahkan Kota</a> </p>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500">Belum ada kota Pembongkaran? <a href="{{ route('cities.create') }}" class="text-blue-500">Tambahkan Kota</a> </p>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="estimated_duration_minute" id="estimated_duration_minute"
                            value="{{ old('estimated_duration_minute') }}"
                            class="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-0 transition-colors duration-200 bg-gray-50 focus:bg-white"
