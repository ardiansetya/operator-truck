...
<div class="container mx-auto px-6 py-8">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Transit Point</h1>
    ...
    <form action="{{ route('transit-points.store') }}" method="POST" class="max-w-lg bg-white p-6 rounded-xl shadow-sm">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="estimated_duration_minute" id="estimated_duration_minute" value="{{ old('estimated_duration_minute') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required min="0">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="extra_cost" id="extra_cost" value="{{ old('extra_cost') }}" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required min="0">
            @error('extra_cost')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        </div>
