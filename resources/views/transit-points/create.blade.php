    ...
    <div class="container mx-auto px-6 max-w-2xl">
        ...
        <div class="bg-white rounded-2xl shadow-xl border-0 overflow-hidden">
            ...
            <form method="POST" action="{{ route('transit-points.store') }}" class="p-8">
                ...
                <!-- Kota Pemuatan -->
                <div class="mb-6">
                    <label for="loading_city_name" class="block text-sm font-semibold text-gray-700 mb-2">
                        Kota Pemuatan
                    </label>
                    <select name="loading_city_name" id="loading_city_name"
                ...
                <!-- Kota Pembongkaran -->
                <div class="mb-6">
                    <label for="unloading_city_name" class="block text-sm font-semibold text-gray-700 mb-2">
                        Kota Pembongkaran
                    </label>
                    <select name="unloading_city_name" id="unloading_city_name"
                        class="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-0 transition-colors duration-200 bg-gray-50 focus:bg-white" required>
                        <option value="">Pilih Kota</option>
                        @foreach ($cities as $city)
                            <option value="{{ $city['id'] }}">{{ $city['name'] }}</option>
