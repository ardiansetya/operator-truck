...
@section('content')
    ...
    <div class="flex flex-col lg:flex-row gap-6 items-center justify-between">
        ...
        <h3 class="text-lg font-semibold text-gray-800 flex items-center space-x-2">
            ...
            <span>Cari Transit Point</span>
        </h3>
        <p class="text-sm text-gray-600 mt-1">Filter transit point berdasarkan kota muat dan bongkar</p>
    </div>

    <form method="GET" action="{{ route('transit-points.index') }}" class="space-y-4 md:space-y-0 md:flex md:items-end md:space-x-4">
        <!-- Loading City -->
        <div class="flex-1">
            <label for="loading_city" class="block text-sm font-medium text-gray-700 mb-2">
                Kota Muat
            </label>
            <div class="relative group">
                ...
                <input 
                    ...
                    placeholder="Masukkan kota muat"
        ...
        <!-- Unloading City -->
        <div class="flex-1">
            <label for="unloading_city" class="block text-sm font-medium text-gray-700 mb-2">
                Kota bongkar
            </label>
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input 
                    ...
                    placeholder="Masukkan kota bongkar"
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 
                           focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 
                           bg-gray-50 focus:bg-white hover:border-gray-400"
                >
        ...
        <div class="flex space-x-3 md:flex-shrink-0">
            ...
            @if(request('loading_city') || request('unloading_city'))
                <a 
                    href="{{ route('transit-points.index') }}" 
        ...
        <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-center space-x-2">
                ...
                <p class="text-sm text-blue-800">
                    ...
                    @if(request('loading_city'))
                        <span class="font-medium">{{ request('loading_city') }}</span>
                    @endif
                    @if(request('loading_city') && request('unloading_city'))
                        →
                    @endif
                    @if(request('unloading_city'))
                        <span class="font-medium">{{ request('unloading_city') }}</span>
                    @endif
                </p>
            </div>
        </div>
