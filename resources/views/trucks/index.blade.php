...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse ($trucks as $index => $truck)
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden transform hover:scale-105">
                <!-- Card Header -->
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $truck['is_available'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <div class="absolute -top-1 -right-1 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center">
                                <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M13.477 14.89A6 6 0 015.11 6.524l8.367 8.368zm1.414-1.414L6.524 5.11a6 6 0 018.367 8.367zM4 10a6 6 0 1012 0A6 6 0 004 10z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        @endif
                    </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <svg class="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16l3-1M6 18l3-1m-6-2v-2"></path>
                                </svg>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <div class="text-center">
                                ...
                                <p class="text-xl font-bold text-gray-800 tracking-wider bg-white px-4 py-2 rounded border-2 border-gray-200">
                                    {{ $truck['license_plate'] }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex space-x-3 mt-6 pt-4 border-t border-gray-200">
                       ...
                       @if ($truck['is_available'])
                            <form method="POST" action="{{ route('trucks.maintance', $truck['id']) }}" class="flex-1" onsubmit="return confirm('Yakin ingin membuat truk maintance?')">
                            @csrf
                            @method('PUT')
                            <button type="submit" 
