    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center space-x-2">
                <span
                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ is_null($delivery['finished_at']) ? 'bg-blue-100 text-blue-800 border border-blue-200' : 'bg-green-100 text-green-800 border border-green-200' }}">
                    <div
                        class="w-2 h-2 rounded-full {{ is_null($delivery['finished_at']) ? 'bg-blue-400' : 'bg-green-400' }} mr-2">
                    </div>
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex flex-wrap gap-2 text-xs text-gray-500">
                                                        @if (isset($transit['transit_point']['estimated_duration_minute']) &&
                                                                $transit['transit_point']['estimated_duration_minute'] !== null)
                                            ...
                                            <div class="flex justify-between items-start">
                                                <div class="flex-1">
                                                    <div class="flex items-center mb-1">
                                                        <span
                                                            class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 mr-2">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-green-50 rounded-xl p-4 border border-green-200">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-2xl font-bold text-green-900">Rp
                            ...
                            <div class="text-center">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ is_null($delivery['finished_at']) ? 'bg-yellow-100 text-yellow-800 border border-yellow-200' : 'bg-green-100 text-green-800 border border-green-200' }}">
        ...
        <div class="mt-8 flex flex-wrap gap-4">
            <a href="{{ route('deliveries.index') }}"
                class="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition duration-200 ease-in-out transform hover:-translate-y-0.5 shadow-lg">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
            ...
            @if (is_null($delivery['finished_at']))
                <form method="POST" action="{{ route('deliveries.finish', $delivery['id']) }}" class="inline"
                    onsubmit="return confirm('Yakin ingin menyelesaikan pengiriman ini?')">
                    @csrf
                    @method('PATCH')
                    <button type="submit"
                        class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition duration-200 ease-in-out transform hover:-translate-y-0.5 shadow-lg">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
