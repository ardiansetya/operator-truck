...
@section('content')
    ...
    @forelse ($deliveries as $index => $delivery)
        <div
            class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 flex flex-col h-full">
            <!-- Card Header -->
            ...
            <!-- Price Breakdown Section - Flexible area -->
            <div class="bg-gray-50 rounded-b-2xl px-6 pt-4 pb-6 flex-1 flex flex-col">
                @php
                ...
                <!-- Transit Routes & Costs - Flex-grow area with consistent height -->
                <div class="flex-1 flex flex-col min-h-[160px]">
                    @if (!empty($accepted_transits))
                        <div class="flex flex-col h-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 pr-2">
                                            <div class="text-xs font-medium text-gray-700">
                                                {{ $transit['loading_city'] }} →
                                                {{ $transit['unloading_city'] }}
                                            </div>
                            ...
                            <!-- Subtotal Extra Cost -->
                            <div class="flex justify-between text-sm py-2 bg-blue-50 px-2 rounded mt-2">
                    ...
                    @else
                        <!-- Placeholder untuk card tanpa transit dengan tinggi tetap -->
                        <div class="flex items-center justify-center text-gray-400 text-sm h-full">
                            <div class="text-center">
                                <svg class="mx-auto h-8 w-8 mb-2 opacity-50" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                    </path>
                                </svg>
                                <span>Tidak ada transit</span>
                            </div>
                        </div>
                    @endif
                </div>

                <!-- Total Price - selalu di bagian bawah -->
                <div class="pt-3 border-t border-gray-300 mt-4">
                    <div class="flex justify-between text-sm">
                ...
                <!-- Action Buttons - selalu di bagian paling bawah -->
