    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                ...
                <p class="text-blue-100 text-sm mt-1">Masukkan informasi lengkap tentang kota</p>
            </div>
            ...
            <form method="POST" action="{{ route('cities.store') }}" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="name" 
                                value="{{ old('name') }}" 
                                class="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400 @error('name') border-red-300 focus:ring-red-500 @enderror" 
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Tentukan lokasi koordinat kota dengan tepat</p>
                        ...
                        <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-blue-800">Tips mencari koordinat:</p>
                                    <p class="text-sm text-blue-700 mt-1">Gunakan Google Maps, klik kanan pada lokasi dan pilih koordinat yang muncul</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="country" 
                                value="{{ old('country') }}" 
                                class="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400 @error('country') border-red-300 focus:ring-red-500 @enderror" 
        ...
        <div class="mt-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border border-green-200">
                ...
                <div>
                    ...
                    <ul class="text-sm text-gray-600 space-y-1">
                        <li class="flex items-center">
                            ...
                            Pastikan nama kota sudah benar dan tidak duplikat
                        </li>
                        <li class="flex items-center">
                            <svg class="w-4 h-4 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg>
                            Koordinat yang akurat akan membantu sistem navigasi
                        </li>
                        <li class="flex items-center">
                            <svg class="w-4 h-4 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg>
                            Data kota akan digunakan untuk rute pengiriman
                        </li>
                    </ul>
                </div>
            </div>
